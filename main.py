...
e1 = Employee('Employee_name1', 'Employee_last_name1',
              date(2018, 3, 12), date(1998, 3, 10),
              'Katowice', '1 maja', '40-006', '123123123')
e2 = Employee('Employee_name2', 'Employee_last_name2',
              date(2015, 2, 19), date(1994, 4, 1),
              'Katowice', '3 maja', '40-008', '123123123')
e3 = Employee('Employee_name3', 'Employee_last_name3',
              date(2020, 1, 4), date(2002, 8, 21),
              'Katowice', 'Mariacka', '40-002', '123123123')
